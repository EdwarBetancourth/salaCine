...
export class init1632340426281 implements MigrationInterface {
    name = 'init1632340426281'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ticket" ("id" SERIAL NOT NULL, "movie_id" integer NOT NULL, "room_id" integer NOT NULL, "hour" integer NOT NULL, CONSTRAINT "PK_d9a0835407701eb86f874474b7c" PRIMARY KEY ("id"))`);
